  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger
        className="flex h-7 min-w-0 items-center gap-1 rounded-md px-1.5 text-2xs font-medium text-muted-foreground outline-none hover:bg-sidebar-accent focus-visible:ring-1 focus-visible:ring-border"
